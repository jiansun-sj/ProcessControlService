...
namespace YumpooDrive.Algorithms.ConnectPool
{
    /// <summary>
    ...
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Algorithms\ConnectPool.cs" region="IConnector Example" title="IConnector示例" />
    /// 然后就可以实现真正的连接池了
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Algorithms\ConnectPool.cs" region="ConnectPoolExample" title="ConnectPool示例" />
    /// </example>
    public class ConnectPool<TConnector> where TConnector : IConnector
    {
        ...
        public ConnectPool( Func<TConnector> createConnector )
        {
            ...
            hybirdLock = new YumpooDrive.Core.SimpleHybirdLock( );
        ...
        private YumpooDrive.Core.SimpleHybirdLock hybirdLock = null;  // 列表操作的锁
