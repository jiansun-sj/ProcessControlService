...
namespace YumpooDrive.ModBus
{
    ...
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="Example2" title="Modbus示例" />
    /// </example>
    public class ModbusRtu : SerialDeviceBase<ReverseWordTransform>
    {
        ...
        /// <example>
        /// 此处演示批量读取的示例
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="ReadExample2" title="Read示例" />
        /// </example>
        ...
        /// <example>
        /// 此处演示批量写入的示例
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="WriteExample2" title="Write示例" />
        /// </example>
