...
namespace YumpooDrive.ModBus
{
    ...
    /// <example>
    /// 基本的用法请参照下面的代码示例
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="Example1" title="Modbus示例" />
    /// </example>
    public class ModbusTcpNet : NetworkDeviceBase<ModbusTcpMessage, ReverseWordTransform>
    {
        ...
        /// <example>
        /// 此处演示批量读取的示例
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="ReadExample1" title="Read示例" />
        /// </example>
        ...
        /// <example>
        /// 此处演示批量写入的示例
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="WriteExample1" title="Write示例" />
        /// </example>
