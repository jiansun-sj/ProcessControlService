...
namespace YumpooDrive.Serial
{
    ...
    /// <example>
    /// 先演示如何校验一串数据的CRC码
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Serial\SoftCRC16.cs" region="Example1" title="SoftCRC16示例" />
    /// 然后下面是如何生成你自己的CRC校验码
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Serial\SoftCRC16.cs" region="Example2" title="SoftCRC16示例" />
    /// </example>
