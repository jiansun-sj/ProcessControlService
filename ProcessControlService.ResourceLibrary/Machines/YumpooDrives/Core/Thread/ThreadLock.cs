...
namespace YumpooDrive.Core
{
    ...
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Core\ThreadLock.cs" region="SimpleHybirdLockExample1" title="SimpleHybirdLock示例" />
    /// </example>
