...
using YumpooDrive.Enthernet;
using YumpooDrive.LogNet;
...
namespace YumpooDrive.Core
{
    ...
    /// <example>
    /// 一个接收的示例
    /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Core\NetSupport.cs" region="ReadBytesFromSocketExample2" title="ReadBytesFromSocket示例" />
    /// </example>
    public static class NetSupport
    {
        ...
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Core\NetSupport.cs" region="ReadBytesFromSocketExample1" title="ReadBytesFromSocket示例" />
        /// 如何接收不定长度的数据呢？我们可以将一条数据拆分成2次接收，第一次是接收8个固定的字节，解析成长度，再接收真实的数据。
        ///  <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Core\NetSupport.cs" region="ReadBytesFromSocketExample3" title="ReadBytesFromSocket示例" />
        /// </example>
        ...
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Core\NetSupport.cs" region="WriteStreamFromSocketExample" title="WriteStreamFromSocket示例" />
        /// </example>
        ...
        /// <code lang="cs" source="YumpooDrive_Net45.Test\Documentation\Samples\Core\NetSupport.cs" region="WriteSocketFromStreamExample" title="WriteSocketFromStream示例" />
        /// </example>
