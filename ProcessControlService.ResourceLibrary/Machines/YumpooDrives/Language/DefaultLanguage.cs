...
namespace YumpooDrive.Language
{
	/// <summary>
	/// 系统的语言基类，默认也即是中文版本
	/// </summary>
...
************************************************************************************/
		...
		public virtual string ToyopucError11 => "CPU模组的硬件异常，无法进行处理。";
		public virtual string ToyopucError20 => "中转指令中的固定数据(ENQ)不为“05”。";
		public virtual string ToyopucError21 => "传送数异常(中转指令中的传送字节数中存在错误)";
		public virtual string ToyopucError23 => "指令代码不正确";
		public virtual string ToyopucError24 => "子指令代码不正确";
		public virtual string ToyopucError25 => "指令格式的数据字节不正确";
		public virtual string ToyopucError26 => "函数调用的操作数不正确";
		public virtual string ToyopucError31 => "想要在顺序运算过程中禁止写入的区域进行写入，或者想 要使用在顺序运算过程中禁止执行的函数调用。";
		public virtual string ToyopucError32 => "停止过程中无效的指令在停止过程中出现。";
		public virtual string ToyopucError33 => "不是调试模式却要进行调试函数调用。";
		public virtual string ToyopucError34 => "通过访问禁止设定禁止访问。";
		public virtual string ToyopucError35 => "设定了执行权限，因而无法执行。";
		public virtual string ToyopucError36 => "通过其他装置设定了执行权限，因而无法执行。";
		public virtual string ToyopucError39 => "进行了I／0点数参数、I／0分配点数参数的写入后。";
		public virtual string ToyopucError3C => "在重大故障发生过程中发出了重大故障中无法执行的指令。";
		public virtual string ToyopucError3D => "执行其他原因的指令过程中处理发生冲突，无法执行。";
		public virtual string ToyopucError3E => "重置过程中，指令无法执行。";
		public virtual string ToyopucError3F => "停止过程中，指令无法执行。";
		public virtual string ToyopucError40 => "读出、写入指令中地址不在范围内，或者指令的地址+数据数脱离地址范围。";
		public virtual string ToyopucError41 => "字符数或者字节数不在范围内。";
		public virtual string ToyopucError42 => "接收到指定范围之外的数据。";
		public virtual string ToyopucError43 => "函数调用的操作数有误。";
		public virtual string ToyopucError52 => "没有使用计时器、计数器，却出现设定值、当前值的读出、写入指令。";
		public virtual string ToyopucError66 => "中转指令指定的连接No、站号的连接模组无应答 (指定的连接模组不存在、电源关闭或者线路异常等)";
		public virtual string ToyopucError70 => "无法使用中转指令指定的连接№的模组(指定的连接№错误，或者连接模组异常)";
		public virtual string ToyopucError72 => "中转指令指定的连接№，站号的连接模组没有应答(指定的连接模组不存在、电源关闭或者线路异常等)";
		public virtual string ToyopucError73 => "CPU模组内多个中转指令在相同连接模组反复发行，无法 进行指令处理。 (请重发指令)";
