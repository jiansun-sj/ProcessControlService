...
namespace ProcessControlService.ResourceLibrary.Machines.Drivers
{
    ...
    public class OpcUaClient
    {
            ...
            try
            {
                ...
                if (ServiceResult.IsBad(e.Status))
                {
                    ...
                    if (m_reconnectHandler == null)
                    {
                        ...
                        m_reconnectHandler.BeginReconnect(Session, ReconnectPeriod * 1000, Server_ReconnectComplete);
                    }
        ...
        {
            Subscription m_subscription = new Subscription(Session.DefaultSubscription);
